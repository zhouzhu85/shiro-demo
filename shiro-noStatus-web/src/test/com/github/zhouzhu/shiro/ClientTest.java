package com.github.zhouzhu.shiro;

import com.github.zhouzhu.shiro.codec.HmacSHA256Utils;
...
public class ClientTest {
    ...
    public static void beforeClass() throws Exception{
        ...
        String webapp = "shiro-noStatus-web/src/main/webapp";
    ...
    public void testServiceHelloSuccess() {
        ...
        String url = UriComponentsBuilder
                .fromHttpUrl("http://localhost:8053/hello")
